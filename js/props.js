...
const PROPS = [
  ...
  // --- ПРИБРАНО: предмети «низьких» станів ---
  // Тут були окремі спрайти на кожну просілу шкалу (мівіна й коробки при
  // 💰≤300, розкидані листки при 📚≤30, купа одягу при 🧠≤30).
  // Їх замінив ОДИН намальований Дашею шар безладу overlays/mess.png —
  // він робить те саме, тільки цілісніше, тож окремі предмети стали зайві.
  //
  // Механізм лишається робочим: захочеш повернути — просто додай сюди
  // рядок з { id, when: { stat, lte } } і поклади PNG у assets/sprites/props/.
];
